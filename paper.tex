...
Cultivating world culture empathy in children through narrative driven
gameplay begs for a theme that is inviting on multiple accounts. We
were drawn to the question of what our target audience looked for in
narration, in addition to what would serve as an aid in encouraging
world cultural empathy. 
We formed a partnership with \textit{[omitted for blind review]}, 
a non-lending branch that 
provides acommunity, training, and technology services in a
...
otherwise---do not seem to be a good match. Indeed, enjoying horror, when
viewed simply as enjoyment of others' pain, seems like the antithesis
of empathy. However, this love of horror, or the monstrous, can be
seen in our culture, touching down on all forms of media. Monsters has
been a hook for narratives throughout history. They have attracted
people of various walks of life, by playing into the fears of the
people.

\citeauthor{Cohen1996} draws attention to this in his book, 
\textit{Monster Theory}~\citeyear{Cohen1996}.
He offers a way of ``reading cultures through the monsters they
engender'' (p.~3).  Cohen notes that the conclusions we come to about
the cultures, from monsters or otherwise, will be a combination of
many fragments rather than a ``smooth epistemological whole.'' A monster
is brought about at a particular time and represents not only the
fears prevalent in the culture but also the values, that lead to that
fear (p.~4--12). Pinning that down is difficult. The monsters work more
as a ``snapshot'' of the culture at a particular moment than a
definition. This point is especially important for us to note when
creating a game whose goal is to encourage children's efforts to see
something from others' perspectives.
%Yet, we see in the children's behavior that ``the same creatures who terrify and interdict can evoke potent escapist fantasies''~(p.16).

For these reasons, monsters have become a staple theme for our
project. They were not only enticing to our target
audience---first observed by our community partner and later proven
through play testing---but also provide an excellent passage for
encouraging empathy, particularly cultural empathy. They represent
