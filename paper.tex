...
in Baghdad---the City of Peace. Notice in Figure~\ref{fig:totan-board}
that Baghdad is the center of the world, much larger and more beautiful
than any other city.

\newcommand{\figwidth}{2.5in}
%\begin{wrapfigure}{R}{\figwidth}
\begin{figure}[b]
\centering
\includegraphics[width=\figwidth]{totan-board}
\caption{Center of the \textit{Tales of the Arabian Nights} game board~\citep{Goldberg2009}.}
\label{fig:totan-board}
%\end{wrapfigure}
\end{figure}
...
important city in the world (Figure~\ref{fig:totan-board}). 
